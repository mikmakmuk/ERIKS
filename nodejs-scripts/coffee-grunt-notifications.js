...
// to normal after 24h
var notifyRandomGuy = function(channel)
{
	...
	slack.apiCall('channels.info',{channel:channel},(response)=> 
	{
		...
		slack.apiCall('users.list',{},(r)=>
		{
			...
			slack.apiCall('chat.postMessage',{channel:channel, as_user:1, text: coffeeMsg.reminder(randomGuy) });
...
// notifyRandomGuy(config.slackBot.channelID);
//setInterval(,1000);
